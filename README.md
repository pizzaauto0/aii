...
Den veröffentlichten Link öffnen und direkt losschreiben. Sobald der erste Text im Eingabefeld steht, beginnt KiwiGPT im Hintergrund mit dem Download von **KiwiGPT Mittel**. Kein API-Schlüssel und kein kostenpflichtiger KI-Dienst nötig.
...
- **KiwiGPT Mini:** 0,5B, ungefähr 1,1 GB Grafikspeicher.
- **KiwiGPT Mittel:** 1,5B, ungefähr 1,9 GB Grafikspeicher und Standard beim ersten Start.
- **KiwiGPT Max:** 3B, ungefähr 2,9 GB Grafikspeicher.

WebGPU ist erforderlich. Browser, Treiber und Geräte können die Ausführung einschränken; insbesondere Mobilgeräte können für Mittel oder Max zu wenig Speicher haben. Es gibt keinen simulierten Antwortmodus und keinen versteckten Cloud-Fallback.
...
- Automatischer Modelldownload beim Schreiben, Modellwechsel, Streaming-Antworten, Stoppen, erneute Antwort, Kopieren, Chatverlauf und Suche.
